...
extern float globalGyroAngle[3], globalAccelAngle[3];
extern float localGyroAngle[3];
extern float FilteredAngle[3];
...
extern void IMUGetAngle(void);
extern void IMUInterrupt(void);
extern void IMUFilter(void);
